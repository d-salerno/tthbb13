...
folder = "/mnt/t3nfs01/data01/shome/dsalerno/TTH_2016/TTH_80X_test2/CMSSW_8_0_19/src/TTH/MEAnalysis/gc"
...
endpath = "/scratch/dsalerno/tth/80x_test2/FHwithme_2pcrel_v2/" #test_4bqcdmem_2/"    

for sample in samples: 
    print "\n",sample
    path = "work.meanalysis_"+sample+"_FHwithmem_2pcrel_v2/output"
    ...
    if( analyse ):
        ...
        h_0_9_422   = TH1F("h_0_9_422","h_0_9_422",200,0,200)
        ...
        h_1_7_322   = TH1F("h_1_7_322","h_1_7_322",200,0,200)
        ...
        h_1_9_422   = TH1F("h_1_9_422","h_1_9_422",200,0,200)
        ...
        for line in s.stdout.readlines():
            if(line.find('stdout') > 0):
                ...
                for l in lines:
                    ...
                    if(l.find('number of events processed:')==0):
                        success += 1
